import { f as createComponent, m as maybeRenderHead, h as addAttribute, k as renderComponent, l as Fragment, r as renderTemplate, n as renderScript, u as unescapeHTML } from '../chunks/astro/server_CgrrVIQx.mjs';
import 'piccolore';
import { $ as $$Layout } from '../chunks/Layout_DCdCGL1q.mjs';
/* empty css                                   */
export { renderers } from '../renderers.mjs';

const $$Socials$1 = createComponent(($$result, $$props, $$slots) => {
  const socials = [
    {
      name: "GitHub",
      handle: "@arjunjayesh",
